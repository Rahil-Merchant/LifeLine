...
public class PendingApplications {
    ...
    private Boolean isAccepted,reqReport;

    public PendingApplications() {

    }

    public PendingApplications(String email, String fname, String mname, String lname, String gender, String occupation, String organization, String mobNo, String bloodGrp, String dob, String last_donated, String uid, String doa, String repdoc, String timeSlot, int timesDonated, int rewards_count, Boolean isAccepted, Boolean reqReport) {
        this.email = email;
        this.fname = fname;
        this.mname = mname;
        this.lname = lname;
